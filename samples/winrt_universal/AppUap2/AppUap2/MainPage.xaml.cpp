...
void  AppUap2::MainPage::UpdateImage(const cv::Mat& image)
{
...
void AppUap2::MainPage::btn1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void AppUap2::MainPage::btn1_Copy_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//lenna filter
	cv::Mat result;
...
void AppUap2::MainPage::btn1_Copy1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
